...
3. When you access `192.168.0.15:8080` from outside, the client routes traffic through Twingate's relay to the connector, which forwards it to the local service
...
4. Define Resources (e.g. `192.168.0.15` or a whole CIDR range) to control what's accessible
